...
What makes it more useful than the alternatives is the **Language-Change Index**: for each contested usage, Garner rates how far it has travelled from rejected to fully accepted, on a five-stage scale. That converts most usage arguments from a matter of taste into a matter of fact — this construction is stage 4, meaning it is virtually universal but still objected to by a few; that one is stage 2, meaning it will mark you as careless to a substantial fraction of readers.
