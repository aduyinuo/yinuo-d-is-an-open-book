...
Headings are the table of contents a reader actually uses. The test: someone should be able to read only the headings and reconstruct the argument. If your headings are "Method", "Results", "Discussion", they carry no information — they describe the genre, not the paper.

Practical rules worth keeping: parallel grammatical form across headings at the same level; specific nouns over abstract ones; no more than three levels; and never let a heading be the antecedent of the first sentence beneath it — the prose has to stand alone.
