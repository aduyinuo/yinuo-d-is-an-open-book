...
<figure><img src="../../.gitbook/assets/next-move-label.png" alt="A table: domain and bottleneck on the left, next moves on the right — read, experiment and code, formalize and write, talk to someone, each with its purposes"><figcaption><p>Name the bottleneck first. The next move is usually obvious afterwards.</p></figcaption></figure>
