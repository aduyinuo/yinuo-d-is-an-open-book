...
<figure><img src="../../.gitbook/assets/social-ipd-network.gif" alt="Agents playing iterated prisoner's dilemma on a network"><figcaption>Eight agents, twelve ties, fourteen rounds. Green edges are mutual cooperation.</figcaption></figure>
...
## Sorting partners into types

<figure><img src="../../.gitbook/assets/social-categorization.gif" alt="One agent categorising nine partners into types as evidence accumulates"><figcaption>One agent, nine partners, sorted and re-sorted as evidence arrives.</figcaption></figure>
