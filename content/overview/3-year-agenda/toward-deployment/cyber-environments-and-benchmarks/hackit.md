...
<figure><img src="../../../../.gitbook/assets/env-hackit.gif" alt="Two engagements on the same configured network: the deception arrives early in one, late in the other"><figcaption><p>Same network, same task. Only when the fake hosts show up differs.</p></figcaption></figure>
