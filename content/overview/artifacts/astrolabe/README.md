...
Built for the [problem-solving](../../3-year-agenda/mental-world-modeling/problem-solving/) studies. Get a transcript in, let several people annotate it against a shared scheme, and measure the agreement rather than assuming it.
