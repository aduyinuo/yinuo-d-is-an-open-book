...
{% endtab %}
{% tab title="1 month" %}
<figure><img src="../.gitbook/assets/activity-heatmap-1m.png" alt="Daily activity across projects, 1 month"><figcaption><p>72 hours logged in the last month</p></figcaption></figure>
{% endtab %}
{% tab title="1 year" %}
...
_at the desk · 1 days ago_

<figure><img src="../.gitbook/assets/heat-the-website.png" alt="Daily work on The Website"><figcaption></figcaption></figure>

* **1 days ago** — removed future-of-work-in-agentic-laboratories-open-science-health-scientists.md
* **1 days ago** — removed trustworthy-controllable-causal-world-model-for-operational-network-defense.md
* **1 days ago** — removed what-makes-it-so-difficult-competitive-cybersecurity-learning-and-workforce-expertise-maintenance.md
* **2 days ago** — wrote into case study
* **2 days ago** — wrote into panel organization
* **2 days ago** — wrote into poster and work in progress
...
_warm · 2 days ago · 21.3h this week_

<figure><img src="../.gitbook/assets/heat-foe-dreamer.png" alt="Daily work on FOE-Dreamer"><figcaption></figcaption></figure>

* **2 days ago** — logged 0.6h — Harvest the side products, such as tips, actionable templates, and methodology for this specific type of rebuttal, slides and pedagogical materials related to the project, reflection on the community's interest &amp; expertise and next steps in this project, logistics and action items for hypothetical next stage, plans for backup and cleansing of artifacts
* **2 days ago** — logged 3.0h — Reflect on lucrative research questions highlighted by reviewer's comments
* **3 days ago** — logged 3.2h — Harvest the side products, such as tips, actionable templates, and methodology for this specific type of rebuttal, slides and pedagogical materials related to the project, reflection on the community's interest &amp; expertise and next steps in this project, logistics and action items for hypothetical next stage, plans for backup and cleansing of artifacts
* **3 days ago** — logged 4.0h — Third draft and submission.
* **3 days ago** — logged 4.3h — Second draft, inspect the comments from various angle, outline rebuttal (template, theme, key papers), infer the stance of reviewers, prioritize and cluster comments, narrow done todo items for each comment, and compile into spreadsheet for the tweak and play next round.
* **3 days ago** — logged 3.9h — First draft, identified the deeper questions in reviewers' comments that worth discussing, and collected some tips about addressing comments for ACSAC
...
_warm · 3 days ago · 3.4h this week_
...
* **3 days ago** — logged 0.2h — Draft survey and interview
* **3 days ago** — logged 1.6h — Read relevant chapters from Antti's book, outline survey and interview
...
_warm · 4 days ago · 2.9h this week_
...
* **4 days ago** — logged 0.2h — Note next steps: connect with the algorithmic primitive paper, write new ideas to overleaf, implement proof of concepts, profile the ctftime, ibm, and Jaime’s course materials as the three basis, design the human experiments for mental operations consensus
* **4 days ago** — logged 2.7h — Project design: map out the space of mental operations, connect write up processing, cognitive based challenge profiling, automated generation of challenges with reasoning demands, specified the role of Stackelberg and PSRO.
...
<summary>CHART — Found out who is the mean editor and made a plan. Now I have to put this down to attend to…</summary>
...
_warm · 2 days ago · 0.3h this week_
