...
The distinction between research versus engineering roles are based on minimum expectations. An ideal applicant to research-focused projects is <mark style="color:$primary;">curious and eager to learn</mark>, <mark style="color:$primary;">focused and tenacious</mark> about proposing and experimenting with new ideas, and <mark style="color:$primary;">fearless to rethink research problems</mark> in light of new techniques. An ideal applicant to engineering-focused project is <mark style="color:$primary;">crafty and caring</mark>, <mark style="color:$primary;">resourceful and flexible</mark> to design and build tools hands-on to solve real-world problems, and <mark style="color:$primary;">open-minded to refactor code</mark> to suit the needs from end-users. Both are encouraged to explore, think, learn, and contribute beyond their committed responsibilities to the projects.

<table><thead><tr><th width="235">Project</th><th width="125">Role</th><th>Question it works on</th></tr></thead><tbody><tr><td><a href="../overview/3-year-agenda/toward-deployment/"><em>Toward Deployment</em></a></td><td>Research</td><td>What are the relationship between cyber agents and physical agents? What are their respective unique challenges? What are transferable across these two domains? <br>A knowledge-graph based comparative study of embodied AI in robotics vs cybersecurity. </td></tr><tr><td><a href="../overview/3-year-agenda/toward-deployment/"><em>Toward Deployment</em></a></td><td>Research Engineer</td><td>A prototype of multi-model defense agent in operational environment. </td></tr><tr><td><a href="../overview/5-year-vista/future-of-work-in-agentic-laboratories-open-science-health-scientists.md"><em>Future of Work in Agentic Laboratory</em></a></td><td>Research</td><td>How can we democratize the benefits of agentic solutions? Do people know how to use Copilot or Claude? A investigation of open source MCP eco-system from a Human-AI teaming perspective</td></tr><tr><td><a href="work-with-me.md#when-is-a-world-model-good-enough">When is a world model good enough?</a><br><a href="../overview/3-year-agenda/cyber-world-modeling/"><em>Cyber World Modeling</em></a></td><td>Research</td><td>How do we decide a world model is reasonably accurate, and which kinds of error are acceptable for a defense agent in an operational network?</td></tr><tr><td><a href="work-with-me.md#expediting-strategic-search-with-a-world-model">Expediting strategic search with a world model</a><br><a href="../overview/3-year-agenda/cyber-world-modeling/"><em>Cyber World Modeling</em></a></td><td>Research</td><td>Can a reasonably accurate model expedite the search for strategic responses, or does a faulty model bias the game-solving step?</td></tr><tr><td><a href="work-with-me.md#fast-adaptation-sample-efficiency-and-strategic-robustness-together">Fast adaptation, sample efficiency, and strategic robustness together</a><br><a href="../overview/3-year-agenda/cyber-world-modeling/"><em>Cyber World Modeling</em></a></td><td>Research</td><td>Can meta-learning, a factored world model, and PSRO be combined without one undermining another, within a real deployment's compute and communication budget?</td></tr><tr><td><a href="work-with-me.md#a-consensus-on-mental-operations-and-learning-them">A consensus on mental operations, and learning them</a><br><a href="../overview/3-year-agenda/mental-world-modeling/"><em>Mental World Modeling</em></a></td><td>Research</td><td>Can mental operations be learned as reusable actions rather than fixed in advance, with a separate account of the control over them?</td></tr><tr><td><a href="work-with-me.md#eliciting-reasoning-under-a-clock">Eliciting reasoning under a clock</a><br><a href="../overview/3-year-agenda/mental-world-modeling/"><em>Mental World Modeling</em></a></td><td>Research</td><td>How do you recover how someone solved a problem when thinking aloud as they go is exactly what you cannot ask for?</td></tr><tr><td><a href="work-with-me.md#testing-what-chart-can-express">Testing what CHART can express</a><br><a href="../overview/3-year-agenda/human-ai-complementarity/"><em>Human-AI Complementarity</em></a></td><td>Research / engineering</td><td>Can the graph express the teamwork in a SOC or an incident response team, and can teamwork be prescribed, monitored, and diagnosed through it?</td></tr><tr><td><a href="work-with-me.md#a-metric-of-complementarity">A metric of complementarity</a><br><a href="../overview/3-year-agenda/human-ai-complementarity/"><em>Human-AI Complementarity</em></a></td><td>Research</td><td>Did the pair reach a decision neither would have reached alone, or did one strong member carry the other?</td></tr><tr><td><a href="work-with-me.md#instrumenting-agent-workflows">Instrumenting agent workflows</a><br><a href="../overview/3-year-agenda/human-ai-complementarity/"><em>Human-AI Complementarity</em></a></td><td>Engineering</td><td>Recording what an agent did in enough detail to attribute a failure to the structure rather than infer it.</td></tr><tr><td><a href="work-with-me.md#an-actionable-taxonomy-of-realism">An actionable taxonomy of realism</a><br><a href="../overview/3-year-agenda/toward-deployment/"><em>Toward Deployment</em></a></td><td>Research</td><td>When we say a realistic cyber environment, what exactly does it entail, and can the relevant parties agree on it?</td></tr><tr><td><a href="work-with-me.md#sim2sim-before-sim2real">sim2sim before sim2real</a><br><a href="../overview/3-year-agenda/toward-deployment/"><em>Toward Deployment</em></a></td><td>Research</td><td>If sim2real can be transformed into sim2sim without losing its complexity, what does that let us measure that we could not before?</td></tr><tr><td><a href="work-with-me.md#cyber-environments-and-benchmarks">Cyber environments and benchmarks</a><br><a href="../overview/3-year-agenda/toward-deployment/"><em>Toward Deployment</em></a></td><td>Engineering</td><td>Keeping the collection of environments runnable, comparable, and documented for what each does and does not represent.</td></tr></tbody></table>
...
### Fast adaptation, sample efficiency, and strategic robustness together

**Role:** research assistant · **Thread:** [Cyber World Modeling](../overview/3-year-agenda/cyber-world-modeling/)

A defender in an operational network has to adapt quickly to an adversary it has not seen, learn from very little data, and stay robust as that adversary changes, all on edge hardware that cannot run a large model. Three lines of work address one of those each: meta-learning gives fast adaptation, a factored world model gives sample efficiency, and PSRO gives robustness to a changing opponent. Pairs of them have been combined before. This project asks whether all three can be put together without one undermining another, and whether what results is feasible inside the compute and communication budget of a real deployment rather than only in a simulator.

**What you need:** reinforcement learning including meta-learning, and enough game theory to work with PSRO; PyTorch; interest in the cost side of the problem, since the constraint that makes this hard is the deployment budget rather than the algorithms individually.
