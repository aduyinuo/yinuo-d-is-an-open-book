...
\begin{frame}{Research}
  ...
  \begin{tikzpicture}[x=1pt,y=1pt]
    ...
    \draw[->,lucidMuted,line width=0.5pt] (86.1,69.0) -- (160.5,68.8);
...
\begin{frame}{Each abstract action on the attack graph can be translated to multiple deceptive capabilities}
  ...
  \begin{tikzpicture}[x=1pt,y=1pt]
    ...
    \draw[->,lucidMuted,line width=0.5pt] (94.7,61.0) -- (168.0,41.3);
...
\begin{frame}[allowframebreaks]{We compared the PPO defender with a heuristic defender}
  ...
  \begin{tikzpicture}[x=1pt,y=1pt]
    ...
    \draw[->,lucidMuted,line width=0.5pt] (72.5,47.8) -- (105.0,47.2);
    \draw[->,ppt980000,line width=0.5pt] (266.7,86.8) -- (266.7,0.0);
    \draw[->,ppt094183,line width=0.5pt] (288.3,70.8) -- (289.0,2.6);
...
\begin{frame}{Model-based reinforcement learning}
  ...
  \begin{tikzpicture}[x=1pt,y=1pt]
    ...
    \draw[->,ppt980000,line width=0.5pt] (69.8,75.8) -- (72.8,24.4);
    ...
    \draw[->,lucidMuted,line width=0.5pt] (12.3,57.2) -- (24.8,57.1);
...
\begin{frame}{Experiment Procedure}
  ...
  \begin{tikzpicture}[x=1pt,y=1pt]
    ...
    \draw[->,lucidMuted,line width=0.5pt] (127.4,114.0) -- (137.4,84.9);
    \draw[->,lucidMuted,line width=0.5pt] (127.4,84.9) -- (137.4,55.8);
    \draw[->,lucidMuted,line width=0.5pt] (183.6,114.0) -- (193.6,84.9);
    \draw[->,lucidMuted,line width=0.5pt] (183.6,84.9) -- (193.6,55.8);
...
\begin{frame}{We proposed an algorithm to enable free-form conversation in groups of LLM agents}
  ...
  \begin{tikzpicture}[x=1pt,y=1pt]
    ...
    \draw[->,lucidMuted,line width=0.5pt] (36.8,79.0) -- (37.0,70.6);
    ...
    \draw[->,lucidMuted,line width=0.5pt] (36.7,34.6) -- (36.8,29.9);
    ...
    \draw[->,lucidMuted,line width=0.5pt] (62.9,70.4) -- (77.9,42.3);
    ...
    \draw[->,lucidMuted,line width=0.5pt] (91.2,125.0) -- (107.4,0.0);
    \draw[->,lucidMuted,line width=0.5pt] (0.0,51.2) -- (49.6,27.5);
...
\begin{frame}{In our ongoing work, we build computationally rational models of human behavior constrained by their internal environment, that is, cognition.}
  ...
  \begin{tikzpicture}[x=1pt,y=1pt]
    ...
    \draw[->,lucidMuted,line width=0.5pt] (45.3,61.6) -- (60.7,61.3);
    \draw[->,lucidMuted,line width=0.5pt] (45.3,49.7) -- (60.9,49.4);
    ...
    \draw[->,lucidMuted,line width=0.5pt] (98.8,78.3) -- (117.3,78.0);
    \draw[->,lucidMuted,line width=0.5pt] (98.8,60.0) -- (117.3,59.7);
